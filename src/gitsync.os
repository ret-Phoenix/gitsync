...
Процедура ДобавитьКомандуExport(Знач Парсер)
    ...
    Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-smart", "<очищать каталог выгрузки только когда есть операции изменение, удаление>");
