...
Функция ПолучитьСписокТестов(Знач Контекст) Экспорт
	...
	ВсеТесты.Добавить("Тест_ДолженЭкспортироватьИспользуяУмныйРежим");
...
Процедура Тест_ДолженЭкспортироватьИспользуяУмныйРежим() Экспорт
	КоличествоКоммитов = ВыполнитьСинхронизацию(3, 4, 0, 1);
	Утверждения.ПроверитьРавенство(КоличествоКоммитов, 2, "Количество коммитов в git-хранилище");
КонецПроцедуры

//////////////////////////////////////////////////////////////////////////////

Функция ВыполнитьСинхронизацию(МинВерсия=0, МаксВерсия=0, Лимит=0, УмныйРежим=0)
	...
	Распаковщик.СинхронизироватьХранилищеКонфигурацийСГит(КаталогИсходников, ПутьКФайлуХранилища1С, МинВерсия, МаксВерсия,,,, Лимит, УмныйРежим);
